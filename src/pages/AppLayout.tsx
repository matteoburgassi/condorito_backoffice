...
import { LayoutDashboard, MonitorSmartphone, FileText, HelpCircle, LogOut, Menu as MenuIcon } from 'lucide-react';
    ...
    <div className="app-shell">
      <aside className={`sidebar${open ? ' open' : ''}`}>
        ...
        <nav className="nav-group">
          ...
          <NavLink to="/documents" className="nav-item" onClick={close}>
            <FileText size={17} />
            Documents
          </NavLink>
